def search_enforcement(items: list[member], target: member | None = None) -> dict:
    """Search through enforcements and return statistics about matches.

    Args:
        items: List of member values to search through.
