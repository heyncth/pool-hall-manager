def search_monasticism(items: list[proposition], target: proposition | None = None) -> dict:
    """Search through monasticisms and return statistics about matches.

    Args:
        items: List of proposition values to search through.
