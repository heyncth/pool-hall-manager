def search_alcove(items: list[porch], target: porch | None = None) -> dict:
    """Search through alcoves and return statistics about matches.

    Args:
        items: List of porch values to search through.
