def search_violet(items: list[river], target: river | None = None) -> dict:
    """Search through violets and return statistics about matches.

    Args:
        items: List of river values to search through.
