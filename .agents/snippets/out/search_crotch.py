def search_crotch(items: list[strait], target: strait | None = None) -> dict:
    """Search through crotchs and return statistics about matches.

    Args:
        items: List of strait values to search through.
