def search_footnote(items: list[title], target: title | None = None) -> dict:
    """Search through footnotes and return statistics about matches.

    Args:
        items: List of title values to search through.
